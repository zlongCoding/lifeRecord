    ...
    <el-col :span="24" class="main">
      <aside :class="collapsed?'menu-collapsed':'menu-expanded'">
        ...
        <ul class="el-menu el-menu-vertical-demo collapsed" v-if="collapsed" ref="menuCollapsed">
          <li v-for="(item,index) in adminRouter" :key="index" class="el-submenu item">
        ...
        >
          <template v-for="(item,index) in adminRouter">
            ...
            <el-menu-item v-if="item.leaf &&item.children.length>0" :key="index" :index="`${item.path}${item.children[0].path}`">
              <i :class="item.iconCls"></i>
...
<script>
import { adminRouter } from "../constance/adminRouter";
export default {
  data() {
    return {
      sysName: "VUEADMIN",
