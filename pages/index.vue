<template>
  <div>
    ...
    <!-- <slide :slideList="slideList" /> -->
      <div class="recommended-container lift-row">
...
import hotNewsList from '../dataJSON/hotNewsList'
import slideList from '../dataJSON/slideList'
import articleList from '../dataJSON/articleList'
export default {
  name: "latestArticles",
  head() {
    return {
